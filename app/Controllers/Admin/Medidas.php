...
class Medidas extends BaseController{
    ...
    public function index() {
            ...
            $data = [
                'titulo' => 'Listando as medidas de protudos',
    ...
    public function excluir($id = null) {
        ...
        if ($medida->deletado_em != null) {
            ...
            return redirect()->back()->with('info', "A medida $medida->nome já encontra-se excluído");
        }
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            return redirect()->to(site_url('admin/medidas'))->with('sucesso', "medida $medida->nome excluído com sucesso!");
        }
