                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($produtoEspecificacoes as $especificacao): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ($especificacao->customizavel ? '<label class="badge bg-primary">Sim</label>' : '<label class="badge badge-warning">Não</label>') ?></td>

                                                <td class="text-center">

                                                    <a href="<?php echo site_url("admin/produtos/excluirespecificacao/$especificacao->id/$especificacao->produto_id"); ?>" class="badge bg-danger">
                                                        &nbsp;X&nbsp;
                                                    </a>
