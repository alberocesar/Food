        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    ...
                    <?php echo date("d F Y",strtotime("$entregador->criado_em")); ?>
                </p>
                ...
                <?php if ($entregador->deletado_em == null): ?>
                    ...
                    <p class="card-text">
                        ...
                        <?php echo date("d F Y",strtotime("$entregador->atualizado_em")); ?>
                    </p>
                ...
                <?php else: ?>
                    ...
                    <p class="card-text">
                        ...
                        <?php echo date("d F Y",strtotime ("$entregador->deletado_em")); ?>
                    </p>
