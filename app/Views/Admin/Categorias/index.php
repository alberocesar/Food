                        ...
                        <tbody>
                            ...
                            <?php foreach ($categorias as $categoria): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($categoria->ativo && $categoria->deletado_em == null ? '<label class="badge bg-primary">Sim</label>' : '<label class="badge bg-danger">Não</label>'); ?></td>

                                    <td>

                                        <?php echo ($categoria->deletado_em == null ? '<label class="badge bg-primary">Disponível</label>' : '<label class="badge bg-danger">Excluído</label>'); ?>
