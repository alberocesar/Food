    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <div class="ui-widget">
                    <input id="query" name="query" placeholder="Pesquise por um medida de protudo" class="form-control bg-light mb-5">
                </div>
                            ...
                            <?php foreach ($medidas as $medida): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo ($medida->deletado_em == null ? '<label class="badge bg-primary">Disponível</label>' : '<label class="badge bg-danger">Excluído</label>'); ?>
