                        ...
                        <tbody>
                            ...
                            <?php foreach ($usuarios as $usuario): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($usuario->ativo && $usuario->deletado_em == null ? '<label class="badge bg-primary">Sim</label>' : '<label class="badge bg-danger">Não</label>'); ?></td>

                                    <td>

                                        <?php echo ($usuario->deletado_em == null ? '<label class="badge bg-primary">Disponível</label>' : '<label class="badge bg-danger">Excluído</label>'); ?>
